...
def run(settings, stop_event=None):
    ...
    with ExitStack() as resources:
        ...
        tags = build_common_tags(settings.user_id, settings.health_api_provider, provider.device_name, settings.device_id)
...
def main():
    ...
    try:
        ...
        configure_logging(settings.log_level, settings.fitbit_log_file_path,
            secrets=(settings.client_secret, settings.google_client_secret, settings.influxdb_password, settings.influxdb_token, settings.influxdb_v3_access_token),
