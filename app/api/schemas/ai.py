...
Category = Literal["sleep", "activity", "workouts", "recovery", "cardiovascular", "body"]
class AnalysisRequest(BaseModel):
    model_config = ConfigDict(extra="forbid", strict=True)
    period: str | None = None
    focus: list[Category] = Field(default_factory=lambda: ["sleep", "activity", "recovery", "workouts"], min_length=1, max_length=6)
